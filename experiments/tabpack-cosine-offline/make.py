    ...
    return {
        ...
        'online_ensembles': {
            'greedy': {
                'type': 'greedy',
                'update_type': 'final',
                'include_current_ensemble_in_pool': False,
                'patience': 10000000,
                ...
                'model': {
                    'num_embeddings': {
                        'd_embedding': [
                            ...
                            'int',
                            8,
                            (24 if dataset == lib.datasets.TABRED_MAPS_ROUTING else 32),
                            4,
                        ],
...
def main() -> None:
    ...
    for dataset in lib.datasets.MAIN_DATASETS:
        ...
        command = (
            ...
            ' --eval-offline-ensembles greedy'
            ' --eval-offline-ensembles-n-seeds 5'
            ' --clean'
        )
